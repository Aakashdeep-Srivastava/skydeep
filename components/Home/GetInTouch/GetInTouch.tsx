...
export default function GetInTouch() {
  ...
  return (
    ...
    >
      ...
      {/* // ? Get In Touch */}
      <span className="text-theme-primary text-3xl sm:text-4xl font-bold tracking-wider opacity-85">Get In Touch</span>
      <p className="flex font-Header tracking-wider text-theme-secondary text-center px-6 sm:px-16 md:px-0 md:w-[600px]">

...
export default function UserDataPullerPage() {
  ...
  const firstVisit_Ref = useRef<HTMLSpanElement>(null);
  const lastVisit_Ref = useRef<HTMLSpanElement>(null);
        ...
        <div className="h-full w-full  py-16 sm:px-12">
          ...
          <div className="w-full pb-6 flex md:flex-row flex-col space-y-4 justify-around items-center">
            <span className="font-bold md:text-4xl text-lg text-AAsecondary">
              ...
              {String(userData.current?.query || "Checking...")}
            </span>
              ...
              <section className="flex flex-col lg:flex-row lg:space-y-0 space-y-3 lg:space-x-4 font-mono">
                ...
                <div className="flex-none flex-col space-y-3">
                  <BlockElem
                    ...
                    value={String(userData.current?.screenOrientationType || "")}
                  />
                  <BlockElem
                    size="w-32"
                    title="Screen size :"
                    value={
                      String(userData.current?.screenWidth || "") +
                      " x " +
                      String(userData.current?.screenHeight || "")
                    }
                  />
                  ...
                  <BlockElem
                    ...
                    value={String(userData.current?.screenColorDepth || "Checking...")}
                  />
                  <BlockElem
                    size="w-44"
                    title="fps :"
